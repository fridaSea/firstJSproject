...
// If condition: with the click it will check for the read more text. if it is equal to "read more" it will change it to "read less". when i click again and it is not equal to "read more" it goes to else and changing it to "read more".
